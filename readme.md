...
[View on GitHub Pages](https://damijjj.github.io/Officer-Card-Generator/)
...
No build tools required. Just open `index.html` in a browser or deploy to any static hosting.
